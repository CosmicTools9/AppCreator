...
mod tests {
    ...
    fn test_enabled_entities_list() {
        ...
        module_config.enabled_entities = vec!["SalesProduct".to_string()];
    ...
    fn test_disabled_entities_priority() {
        let mut module_config = ModuleModelConfig::default();
        module_config.enabled_entities =
            vec!["ManuProduct".to_string(), "SalesProduct".to_string()];
        module_config.disabled_entities = vec!["ManuProduct".to_string()];
