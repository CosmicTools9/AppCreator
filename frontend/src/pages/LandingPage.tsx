...
const CAPABILITIES = [
  {
    icon: 'chat',
    title: '对话式需求拆解',
    desc: 'AI 引导你逐步细化需求，从模糊描述到精确功能规格，自动产出需求文档与原型框架。',
  },
  {
    icon: 'layout',
    title: '高保真原型即时生成',
    desc: '单文件 HTML 应用原型，可交互、可预览、可下载。支持无限次迭代，每次对话即更新原型。',
  },
  {
    icon: 'layers',
    title: '企业级原型框架输出',
    desc: '生成的 HTML 原型遵循 Alioth 命名规范与数据模型模式，为后续扩展预留接口，生产级架构理念开箱即用。',
  },
  {
    icon: 'clock',
    title: '即时预览与迭代',
    desc: '每次对话更新原型，可即时预览交互式 HTML。迭代周期从数周压缩到分钟级。',
  },
  {
    icon: 'grid',
    title: '模块化扩展体系',
    desc: '生成的每个应用基于 Alioth 模块化架构，支持后期按需扩展、集成 Gateway 统一入口与 SSO 认证。',
  },
  {
    icon: 'shield',
    title: '企业级安全合规',
    desc: '继承 Alioth 的 NGAC 权限模型、SSO JWT 认证、四层环境隔离。生成的代码天然符合企业安全审计要求。',
  },
];
...
const FAQS = [
  {
    q: '免费预览能做什么？',
    a: '用 AI 对话创建应用原型，预览、下载、无限次迭代全部免费。只有需要可部署的源码包时才付费。',
  },
  {
    q: '「每月 60 个产品原型额度」怎么算？',
    a: '每开启一个全新应用算 1 个额度；同一应用内的对话迭代不消耗额度，重新生成也不计费。',
  },
  {
    q: '源码包怎么收费？',
    a: '专业订阅内含首次源码包下载（¥4,999）；后续再次下载仅 ¥19.9/次；原型迭代本身免费。',
  },
  {
    q: '生成的应用用什么技术栈？',
    a: 'Rust 后端 + React 前端 + PostgreSQL，遵循 Alioth 四层隔离架构，Docker 编排开箱即用。',
  },
  {
    q: '支持私有部署与数据安全吗？',
    a: '免费版与专业版为云服务；企业版（AliothStudio）支持 Docker 私域单机 / 集群部署，配套独立 SSO 与 NGAC 权限模型。',
  },
  {
    q: '没有技术团队也能上线吗？',
    a: '源码包附带 Docker 编排与部署文档，一条命令完成构建部署；企业版可联系我们提供上线协助。',
  },
];
    ...
    <>
      ...
      <nav className="landing-nav">
        <div className="container">
          ...
          <ul className="nav-links">
            ...
            <li>
              <a href="#caps" onClick={scrollTo('caps')}>
                能力
              </a>
            </li>
            <li>
              <a href="#templates" onClick={scrollTo('templates')}>
                模板
              </a>
            </li>
          </ul>
      ...
      <div className="welcome">
        ...
        <p className="hero-sub">
          用自然语言描述你的管理需求——AppCreator 即时生成生产级企业应用原型。管理后台、审批流、ERP
          模块、数据看板，对话即可完成。
        </p>
            ...
            <div className="demo-main">
              ...
              <div className="demo-msg-row ai">
                ...
                <div className="demo-bubble">
                  ...
                  <br />
                  <br />
                  <strong>➕ 新建客户表单</strong>
                  <br />
                  · 字段：公司名称、行业、联系人、电话、邮箱、备注
                  <br />
                  · 保存后自动跳转详情页
                  <br />
                  <br />
        ...
        {/* Capabilities */}
        <div className="section-label" id="caps">
          —— 核心能力
        </div>
        ...
        {/* Templates */}
        <div className="section-label" id="templates">
          —— 适用场景
        </div>
        ...
        <div className="pricing-grid">
          ...
          <div className="pricing-card">
            ...
            <button className="btn btn-secondary btn-block" onClick={() => navigate('/workspace')}>
              免费开始
            </button>
          </div>
          {/* 专业订阅 */}
          <div className="pricing-card featured">
            ...
            <p className="pricing-price">
              <span className="pricing-amount">¥1,399</span>
            ...
            <ul className="pricing-features">
              ...
              <li>每个原型无限次对话迭代</li>
              <li>
                首次源码包下载 <strong>¥4,999</strong>
              </li>
              <li>重新生成不计费</li>
              <li>
                再次下载仅 <strong>¥19.9/次</strong>
              </li>
              <li>优先技术支持</li>
            </ul>
            <button className="btn btn-primary btn-block" onClick={() => navigate('/workspace')}>
              立即订阅
            </button>
          </div>
          {/* AliothStudio = 企业定制 */}
          <div className="pricing-card">
            ...
            <p className="pricing-price">
              <span className="pricing-amount">¥499,999</span>
            </p>
            <ul className="pricing-features">
              <li>基于元数据的自定义扩展</li>
              <li>从元数据自定义实体与字段</li>
        ...
        <p className="pricing-note">
          计费说明：原型生成与迭代全程免费；源码包为一次性下载（专业版首单 ¥4,999，后续
          ¥19.9/次）；企业版按定制方案报价。
        </p>
