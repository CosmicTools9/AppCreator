  ...
  <header class="h-14 border-b flex items-center justify-between px-6 bg-background shrink-0">
    <div class="flex items-center gap-2 min-w-0 relative h-full">
      ...
      <div class="flex items-center h-full gap-0.5 pl-1">
        ...
        <a href="#" class="relative inline-flex items-center gap-1.5 px-3 py-1 text-[13px] font-medium no-underline transition-colors text-muted-foreground hover:bg-accent rounded-t-lg" title="AI 助手">
          <span class="whitespace-nowrap">AI 助手</span>
        </a>
      </div>
    </div>
    ${previewTopBarRight({
